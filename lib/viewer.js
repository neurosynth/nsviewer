...
(function() {
  ...
  UserInterface = (function() {
    ...
    UserInterface.prototype.addSlider = function(name, element, orientation, range, min, max, value, step) {
  ...
  View = (function() {
    function View(viewer, element, dim, labels) {
      this.viewer = viewer;
    ...
    View.prototype.click = function(e) {
      ...
      xyz = this.viewer.coords;
      offset = $(e.target).offset();
      cx = e.pageX - offset.left;
      cy = e.pageY - offset.top;
      cx /= this.width;
      cy /= this.height;
      this.viewer.cxyz = (function() {
        switch (this.dim) {
          case 2:
            return [cx, cy, this.viewer.cxyz[2]];
          case 1:
            return [cx, this.viewer.cxyz[1], cy];
          case 0:
            return [this.viewer.cxyz[0], cx, cy];
        }
      }).call(this);
