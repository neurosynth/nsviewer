...
(function() {
  ...
  _Viewer = (function() {
    ...
    _Viewer.prototype.deleteLayer = function(index) {
      this.layerList.deleteLayer(index);
  ...
  LayerList = (function() {
    ...
    LayerList.prototype.deleteLayer = function(name) {
  ...
  UserInterface = (function() {
    ...
    UserInterface.prototype.updateLayerList = function(layers, selectedIndex) {
      ...
      for (i = _i = 0, _ref = layers.length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
        l = layers[i];
        $(this.layerListId).append($("<li class='layer_list_item'><div class='layer_label'>" + l + "</div><i class=\"icon-eye-open toggle_img\"></i></li>"));
      }
  ...
  ViewSettings = (function() {
    ...
    */
    function ViewSettings(options) {
      ...
      this.crosshairs = new Crosshairs(this.crosshairsEnabled, this.crosshairsColor, this.crosshairsWidth);
    }
  ...
  View = (function() {
    ...
    View.prototype._jQueryInit = function() {
      ...
      canvas.mousemove(function(evt) {
        ...
        if (!_this.viewSettings.panEnabled) {
          return;
        }
        _this.lastX = evt.offsetX || (evt.pageX - canvas.offsetLeft);
        _this.lastY = evt.offsetY || (evt.pageY - canvas.offsetTop);
    ...
    View.prototype._zoom = function(clicks) {
      ...
      if (!this.viewSettings.zoomEnabled) {
        return;
      }
