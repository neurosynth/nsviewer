jQuery(document).ready(function() {
	...
	viewer.addSlider("nav-xaxis", ".slider#nav-xaxis", "horizontal", "false", 0, 1, 0.5, 0.01, Viewer.XAXIS);
	viewer.addSlider("nav-yaxis", ".slider#nav-yaxis", "vertical", "false", 0, 1, 0.5, 0.01, Viewer.YAXIS);
	viewer.addSlider("nav-zaxis", ".slider#nav-zaxis", "vertical", "false", 0, 1, 0.5, 0.01, Viewer.ZAXIS);
