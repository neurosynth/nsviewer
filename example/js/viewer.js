...
(function() {
  ...
  window.Viewer = Viewer = (function() {
    ...
    Viewer.prototype.addSlider = function(name, element, orientation, min, max, value, step, dim, textField) {
      ...
      if (name.match(/nav/)) {
        ...
        results = [];
        for (q = 0, len = views.length; q < len; q++) {
          v = views[q];
    ...
    Viewer.prototype.addSettingsCheckboxes = function(element, options) {
      ...
      options = (function() {
        var len, q, results;
        results = [];
        for (q = 0, len = options.length; q < len; q++) {
          o = options[q];
    ...
    Viewer.prototype.loadImages = function(images, activate, assignColors) {
      var ajaxReqs, data, existingLayers, img, len, q;
      if (activate == null) {
        activate = null;
      }
      ...
      images = (function() {
        var len, q, ref, results;
        results = [];
        for (q = 0, len = images.length; q < len; q++) {
          img = images[q];
      ...
      return $.when.apply($, ajaxReqs).then((function(_this) {
        return function() {
          ...
          order = (function() {
            var len1, results, t;
            results = [];
            for (t = 0, len1 = images.length; t < len1; t++) {
              i = images[t];
              results.push(i.name);
            }
            return results;
  ...
  Image = (function() {
    function Image(data) {
      var i, j, k, len, p, q, ref, ref1, ref2, ref3, ref4, t, u, vec, w;
      ...
      if ('data3d' in data) {
        for (i = q = 0, ref1 = this.x; 0 <= ref1 ? q < ref1 : q > ref1; i = 0 <= ref1 ? ++q : --q) {
          for (j = t = 0, ref2 = this.y; 0 <= ref2 ? t < ref2 : t > ref2; j = 0 <= ref2 ? ++t : --t) {
            for (k = u = 0, ref3 = this.z; 0 <= ref3 ? u < ref3 : u > ref3; k = 0 <= ref3 ? ++u : --u) {
      ...
      if ('peaks' in data) {
        ref4 = data.peaks;
        for (w = 0, len = ref4.length; w < len; w++) {
          p = ref4[w];
    ...
    Image.prototype.addSphere = function(coords, r, value) {
      var dist, i, j, k, q, ref, ref1, ref2, ref3, ref4, ref5, ref6, t, u, x, y, z;
      if (value == null) {
        value = 1;
      }
      if (r <= 0) {
      ...
      for (i = q = ref1 = -r, ref2 = r; ref1 <= ref2 ? q <= ref2 : q >= ref2; i = ref1 <= ref2 ? ++q : --q) {
        if ((x - i) < 0 || (x + i) > (this.x - 1)) {
          continue;
        }
        for (j = t = ref3 = -r, ref4 = r; ref3 <= ref4 ? t <= ref4 : t >= ref4; j = ref3 <= ref4 ? ++t : --t) {
          if ((y - j) < 0 || (y + j) > (this.y - 1)) {
            continue;
          }
          for (k = u = ref5 = -r, ref6 = r; ref5 <= ref6 ? u <= ref6 : u >= ref6; k = ref5 <= ref6 ? ++u : --u) {
  ...
  LayerList = (function() {
    ...
    LayerList.prototype.sortLayers = function(newOrder, destroy, newOnTop) {
      var counter, i, l, len, n_layers, n_new, newLayers, ni, q, ref;
      if (destroy == null) {
        destroy = false;
      }
      if (newOnTop == null) {
  ...
  ColorMap = (function() {
    ...
    for (q = 0, len = basic.length; q < len; q++) {
      col = basic[q];
    ...
    ColorMap.prototype.map = function(data) {
      var c, dims, i, j, ref, ref1, res, rgb, t, u, v, val, w;
      dims = data.shape;
      dims.push(3);
      res = ndarray(new Float32Array(dims[0] * dims[1] * 3), dims);
      for (i = t = 0, ref = data.shape[0]; 0 <= ref ? t < ref : t > ref; i = 0 <= ref ? ++t : --t) {
        for (j = u = 0, ref1 = data.shape[1]; 0 <= ref1 ? u < ref1 : u > ref1; j = 0 <= ref1 ? ++u : --u) {
          v = data.get(i, j);
          if (v === 0) {
            rgb = [NaN, NaN, NaN];
          } else {
    ...
    ColorMap.prototype.setColors = function(colors) {
      ...
      colors = [];
      for (i = t = 1, ref = this.steps; 1 <= ref ? t < ref : t > ref; i = 1 <= ref ? ++t : --t) {
  ...
  Threshold = (function() {
    ...
    Threshold.prototype.mask = function(data) {
      var i, j, q, ref, ref1, res, t, v, val;
  ...
  Transform = {
    jsonToVector: function(data) {
      var curr_inds, i, j, q, ref, ref1, ref2, t, u, v;
      v = new Float32Array(data.dims[0] * data.dims[1] * data.dims[2]);
      for (i = q = 0, ref = v.length; 0 <= ref ? q < ref : q > ref; i = 0 <= ref ? ++q : --q) {
        v[i] = 0;
      }
      for (i = t = 0, ref1 = data.values.length; 0 <= ref1 ? t < ref1 : t > ref1; i = 0 <= ref1 ? ++t : --t) {
        curr_inds = data.indices[i];
        for (j = u = 0, ref2 = curr_inds.length; 0 <= ref2 ? u < ref2 : u > ref2; j = 0 <= ref2 ? ++u : --u) {
  ...
  UserInterface = (function() {
    ...
    UserInterface.prototype.checkboxesChanged = function() {
      var id, len, q, ref, s, settings, val;
      settings = {};
      ref = $('.settings_box');
      for (q = 0, len = ref.length; q < len; q++) {
        s = ref[q];
    ...
    UserInterface.prototype.updateLayerList = function(layers, selectedIndex) {
      var deletion_icon, download_icon, i, l, q, ref, visibility_icon;
      $(this.layerListId).empty();
      for (i = q = 0, ref = layers.length; 0 <= ref ? q < ref : q > ref; i = 0 <= ref ? ++q : --q) {
        l = layers[i];
    ...
    UserInterface.prototype.updateLayerVisibility = function(visible) {
      ...
      results = [];
      for (i = q = 0, ref = visible.length; 0 <= ref ? q < ref : q > ref; i = 0 <= ref ? ++q : --q) {
        if (visible[i]) {
  ...
  View = (function() {
    ...
    View.prototype.paint = function(layers) {
      var _val, aa, c, data, dims, fuzz, i, img, j, l, ld, len, len1, n, q, ref, ref1, t, u, val, vox_rgb, w, xCell, xp, yCell, yp;
      img = layers[0].image;
      ...
      data = [];
      for (q = 0, len = layers.length; q < len; q++) {
        l = layers[q];
        ld = l.slice(this.dim);
        ld = l.threshold.mask(ld);
        data.push(l.colorMap.map(ld));
      }
      for (i = t = 0, ref = data[0].shape[0]; 0 <= ref ? t < ref : t > ref; i = 0 <= ref ? ++t : --t) {
        for (j = u = 0, ref1 = data[0].shape[1]; 0 <= ref1 ? u < ref1 : u > ref1; j = 0 <= ref1 ? ++u : --u) {
          vox_rgb = [];
          for (c = w = 0; w < 3; c = ++w) {
            val = 0.0;
            for (n = aa = 0, len1 = layers.length; aa < len1; n = ++aa) {
              l = layers[n];
              if (l.visible) {
