...
(function() {
  var ColorMap, Crosshairs, DataField, DataPanel, Image, Layer, LayerList, Slider, Threshold, Transform, UserInterface, View, ViewSettings, Viewer, _Viewer,
  ...
  window.Viewer = Viewer = (function() {
    ...
    Viewer.get = function(layerListElement, layerSettingClass, cache, options) {
      var _ref;
      if (cache == null) {
        cache = true;
      }
      ...
      return (_ref = this._instance) != null ? _ref : this._instance = new _Viewer(layerListElement, layerSettingClass, cache, options);
    };
  ...
  _Viewer = (function() {
    ...
    function _Viewer(layerListId, layerSettingClass, cache, options) {
    ...
    _Viewer.prototype.addSettingsCheckboxes = function(element, options) {
    ...
    _Viewer.prototype._loadImageFromVolume = function(options) {
      var dfd, r, v,
        _this = this;
      dfd = $.Deferred();
    ...
    _Viewer.prototype.downloadImage = function(index) {
      var url;
    ...
    _Viewer.prototype.deleteLayer = function(target) {
    ...
    _Viewer.prototype.updateViewSettings = function(options, paint) {
      if (paint == null) {
        paint = false;
      }
  ...
  Image = (function() {
    ...
    function Image(data) {
      var i, j, k, p, value, vec, _i, _j, _k, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
      ...
      if ('peaks' in data) {
        ...
        for (k in _ref5) {
          p = _ref5[k];
          this.addSphere(Transform.atlasToImage([p.x, p.y, p.z]), (_ref6 = p.r) != null ? _ref6 : p.r = 3, (_ref7 = p.value) != null ? _ref7 : p.value = 1);
        }
        this.max = 2;
      }
    }
