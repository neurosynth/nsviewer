...
(function() {
  var CheckboxComponent, ColorMap, Component, Crosshairs, DataField, DataPanel, Image, Layer, LayerList, SelectComponent, SliderComponent, Threshold, Transform, UserInterface, View, ViewSettings, Viewer, _ref,
  ...
  */
  ...
  Image = (function() {
    function Image(data) {
      var i, j, k, p, value, vec, _i, _j, _k, _l, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
  ...
  UserInterface = (function() {
    ...
    UserInterface.prototype.addSlider = function(name, element, orientation, min, max, value, step, dim) {
      return this.components[name] = new SliderComponent(this, name, element, orientation, min, max, value, step, dim);
    };
  ...
  View = (function() {
    ...
    View.prototype.addSlider = function(name, element, orientation, min, max, value, step, dim) {
      return this.slider = new SliderComponent(this, name, element, orientation, min, max, value, step, dim);
    };
  ...
  CheckboxComponent = (function(_super) {
    __extends(CheckboxComponent, _super);

    function CheckboxComponent() {
      _ref = CheckboxComponent.__super__.constructor.apply(this, arguments);
      return _ref;
    }
